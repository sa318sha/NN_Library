...
breastCancerPredictionModel.compile(
    loss_function=metrics.categorical_crossEntropy, metrics=[metrics.accuracy])
...
while (userChoice != 0):
    ...
    if(userChoice == '2'):
        ...
        breastCancerPredictionModel.fit(
            numberOfIterations, 20, X, y, validation_split=0.25)
